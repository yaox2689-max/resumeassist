...
class MemoryStore:
    ...
    Layout:
        ...
        <root>/<user_id>/<resume_id>/INTERVIEW_NOTE.md — resume-level
    ...
    def read_interview_note(self, user_id: str, resume_id: str) -> str:
        path = self._interview_note_path(user_id, resume_id)
        return path.read_text(encoding="utf-8") if path.exists() else ""
    ...
    async def merge_interview_note(
        self,
        user_id: str,
        resume_id: str,
        old_content: str,
        ...
        """Merge old INTERVIEW_NOTE with new facts using the provided merge function.
        ...
        self.write_interview_note(user_id, resume_id, merged, max_chars=max_chars)
        return merged
    ...
    def _interview_note_path(self, user_id: str, resume_id: str) -> Path:
        return self.root / user_id / resume_id / "INTERVIEW_NOTE.md"
